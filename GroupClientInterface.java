...
public interface GroupClientInterface
{
	 ...
	 * @param weakSecret The user's password
	 ...
	 * @param fileServerIPAndPort a string array representing the ip and port of the file server the token will be used on
     *
     * @return A UserToken describing the permissions of "username."
     *         If this user does not exist, a null value will be returned.
     *
     */
    public UserToken getToken(final String username, final String[] fileServerIPAndPort);
     ...
     *
     */
    public boolean createUser(final String username, final String weakSecret, final UserToken token);
